...
const gameBoard = (() => {
    ...
    const checkVictory = () => {
        ...
        // Check each column
        for(let c = 0; c < 3; c++) {
            if (checkEmptyPosition(c,0) || checkEmptyPosition(c,1) || checkEmptyPosition (c,2)) {
                continue;
            }
        ...
        // Check each row
        for(let r = 0; r < 3; r++) {
            if (checkEmptyPosition(0,r) || checkEmptyPosition(1,r) || checkEmptyPosition (2,r)) {
                continue;
            }
        ...
        // Check each diagonal
        // Negative diagonal
        if (!checkEmptyPosition(0,0) && !checkEmptyPosition(1,1) && checkEmptyPosition(2,2)) {
            if (board[0][0] === board[1][1] && board[0][0] === board[2][2]) {
                return board[1][1];
            }
        }
        // Positive diagonal
        if (!checkEmptyPosition(0,2) && !checkEmptyPosition(1,1) && checkEmptyPosition(2,0)) {
